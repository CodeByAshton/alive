      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring/40 absolute top-4 right-4 rounded-md opacity-60 transition-opacity hover:opacity-100 focus:ring-2 focus:outline-none disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
